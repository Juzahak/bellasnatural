        ...
        <>
            ...
            <section>
                <div className="container">
                    ...
                    <div className='col-12 d-flex mt-5 mob-column'>
                        <div className='col-12 col-lg-6 text-center d-flex justify-content-center mr-1'>
                            <div style={{ borderRadius: '5px', overflow: 'hidden' }}>
                                <Image src={require("../assets/img/soap1.jpg")} alt="" height={320} style={{ marginBottom: '25px' }}/>
                            </div>
                        </div>
                        <div className='col-12 col-lg-6 d-flex flex-column justify-content-center ml-1'>
            ...
            <section className="section ec-offer-section section-space-mt section-space-mb">
                ...
                <div className='mob-banner' style={{ width: '100%', height: '600px' }}>
                    <Image src={require("../assets/img/banner/banner-sobre.jpg")} alt="" className='imageBanner'/>
                </div>
                        ...
                        <div className="col-md-12 text-center">
                            ...
                            <div className='col-12 d-block d-md-flex mt-4 justify-content-center'>
                                ...
                                <div className='col-12 col-md-2 d-flex flex-md-column justify-content-around'>
                                    <Image src={require("../assets/img/soap2.jpg")} alt="" className="grid-img-small" />
                                </div>

                                <div className='col-12 col-md-2 d-flex flex-md-column justify-content-around mob-column'>
                                    <Image src={require("../assets/img/soap2.jpg")} alt="" className="grid-img-small" />
                                    <Image src={require("../assets/img/soap2.jpg")} alt="" className="grid-img-small" />
                                </div>

                                <div className='col-12 col-md-4'>
                                    <Image src={require("../assets/img/soap2.jpg")} alt="" className="grid-img" />
                                </div>
